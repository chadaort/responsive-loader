...
function loader(content) {
    ...
    const { mime, ext, name, sizes, outputPlaceholder, injectPlaceholder, placeholderSize, imageOptions, cacheOptions } = (0, utils_1.parseOptions)(this.resourcePath, options);
    if (!mime) {
...
async function transform({ adapterModule, resourcePath, createFile, sizes, mime, outputPlaceholder, placeholderSize, injectPlaceholder, adapterOptions, }) {
